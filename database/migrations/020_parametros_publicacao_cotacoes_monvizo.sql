...
VALUES
  ...
  ('URL_PUBLICA_COTACAO', 'http://cotacoes.monvizo.com.br:8080/', 'URL publica base para links de cotacao enviados para transportadoras.', FALSE),
...
UPDATE empresas
SET dominio_publico = 'cotacoes.monvizo.com.br:8080',
  alterado_em = NOW()
